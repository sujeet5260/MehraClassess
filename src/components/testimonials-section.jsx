    ...
    <section ref={sectionRef} className="py-20 px-4 bg-secondary/30">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-sans text-4xl md:text-5xl font-bold text-foreground mb-6">What Students Say</h2>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <CardContent className="p-8">
                ...
                <p className="font-serif text-muted-foreground mb-6 leading-relaxed italic">"{testimonial.content}"</p>
                ...
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <h4 className="font-sans font-bold text-card-foreground">{testimonial.name}</h4>
                    <p className="font-serif text-sm text-muted-foreground">{testimonial.role}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
