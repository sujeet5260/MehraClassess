    ...
    <section ref={sectionRef} className="py-20 px-4 bg-background">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-sans text-4xl md:text-5xl font-bold text-foreground mb-6">About Me</h2>
        ...
        <div ref={cardsRef} className="grid md:grid-cols-3 gap-8">
          <Card className="bg-card border-border hover:shadow-lg transition-shadow duration-300">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="font-sans text-xl font-bold text-card-foreground mb-4">Education</h3>
              <p className="font-serif text-muted-foreground">
                M.Ed in Curriculum & Instruction from Stanford University. Specialized in digital learning
                methodologies.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-card border-border hover:shadow-lg transition-shadow duration-300">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="font-sans text-xl font-bold text-card-foreground mb-4">Experience</h3>
              <p className="font-serif text-muted-foreground">
          ...
          <Card className="bg-card border-border hover:shadow-lg transition-shadow duration-300">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="font-sans text-xl font-bold text-card-foreground mb-4">Recognition</h3>
              <p className="font-serif text-muted-foreground">
